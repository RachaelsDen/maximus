...
#define FLAG_break_clr                                                                             \
    0x0020                   /* Send a break signal to dump modem's    6*                          \
                              * internal buffer                         */
#define FLAG_log_echo 0x0040 /* Log user-written echomail              7*/
#define FLAG_no_ulist                                                                              \
    0x0080                     /* User can't press '?' to list users in  8*                        \
                                * msg.                                    */
...
#define FLAG_lbaud96                                                                               \
    0x2000 /* If we should use 9600 baud for local   4*                                            \
            * callers... (For Opus compatibility!)    */
#define FLAG_alias                                                                                 \
    0x4000 /* If we're running a system which allows 5*                                            \
            * aliases or handles                      */
#define FLAG_ask_name                                                                              \
    0x8000 /* If we should ask user for their alias  6*                                            \
