...
/*
int Parse_Questionnaire(FILE *bbsfile,FILE **questfile,char *onexit,char *filename,int *ck_abort,int
*recd_chars,int *skipcr,char **filebufr,char *nonstop,int allanswers)
*/
...
word DisplayQuestionnaire(DSTK *d)
{
    ...
    case 'C': /* Call DOS with command 'p' (in '^OCp') */
    {
        ...
        Outside(NULL, NULL, OUTSIDE_DOS | rr, p, FALSE, CTL_NONE, RESTART_DOTBBS, d->scratch);
