...
#define MAX_LANG_track    /* Tracker language strings */
...
int TrackQWKUpdateTracking(QWKTRACKINFO *pqti)
{
    ...
    if (pqti->update_comment && *pqti->szNewComment)
    {
        ...
        TrackInsertTracking(sq, MsgUidToMsgn(sq, pqti->tmn.tl.uid, UID_EXACT), NULL, FALSE, FALSE,
                            NULL, FALSE, NULL, TRUE, szNewComment);
    }
