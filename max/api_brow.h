...
#define BROWSE_EXACT                                                                               \
    0x1000                 /* Match search strings EXACTLY               *                         \
                            * (ie. use stricmp(), not stristr().)        */
#define BROWSE_HASH 0x2000 /* Use hash compare for this one only         */

#define BROWSE_AREA                                                                                \
    (BROWSE_ACUR | BROWSE_ATAG | BROWSE_AALL | BROWSE_AWLD | BROWSE_AGRP | BROWSE_ALNT)
...
#define SCAN_BLOCK_SBREC                                                                           \
    512                       /* # of msgs to read in from scanfile at    *                        \
