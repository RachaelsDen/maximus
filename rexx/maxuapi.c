...
static char rcs_id[] = "$Id: maxuapi.c,v 1.1.1.1 2002/10/01 17:54:48 sdudley Exp $";
...
#define SetRxString(r, p)                                                                          \
    strcpy((r).strptr, p);                                                                         \
    (r).strlength = strlen(p)
...
static int near GetHufArg(PRXSTRING prxs, int *piHuf)
{
    ...
    if (iHuf < 0 || iHuf >= MAX_HUF || aHuf[iHuf] == 0)
    {
        return FALSE;
    }
...
static int near GetHuffArg(PRXSTRING prxs, int *piHuff)
{
    ...
    if (iHuff < 0 || iHuff >= MAX_HUFF || aHuff[iHuff] == 0)
    {
        return FALSE;
    }
...
OS2UINT APIENTRY RMaxLoadFuncs(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                               PRXSTRING prxsRet)
{
    char **pt;
    int retval = 0;
...
OS2UINT APIENTRY RMaxUnloadFuncs(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                 PRXSTRING prxsRet)
{
    int retval;
...
OS2UINT APIENTRY MaxTrap(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                         PRXSTRING prxsRet)
{
    (void)pszName;
    (void)argc;
...
OS2UINT APIENTRY RUserFileOpen(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                               PRXSTRING prxsRet)
{
    int iHuf;
    int iMode;
...
OS2UINT APIENTRY RUserFileSize(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                               PRXSTRING prxsRet)
{
    int iHuf;
    long lSize;
...
OS2UINT APIENTRY RUserFileFind(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                               PRXSTRING prxsRet)
{
    int iHuf;
    char szName[PATHLEN];
    ...
    rc = UserFileFind(aHuf[iHuf], *szName ? szName : NULL, *szAlias ? szAlias : NULL, &usr);
...
OS2UINT APIENTRY RUserFileFindOpen(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                   PRXSTRING prxsRet)
{
    int iHuf, iHuff;
    char szName[PATHLEN];
    ...
    if ((aHuff[iHuff] = UserFileFindOpen(aHuf[iHuf], *szName ? szName : NULL,
...
OS2UINT APIENTRY RUserFileFindNext(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                   PRXSTRING prxsRet)
{
    int iHuff;
    char szName[PATHLEN];
    ...
    rc = UserFileFindNext(aHuff[iHuff], *szName ? szName : NULL, *szAlias ? szAlias : NULL);
...
OS2UINT APIENTRY RUserFileFindPrior(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                    PRXSTRING prxsRet)
{
    int iHuff;
    char szName[PATHLEN];
    ...
    rc = UserFileFindPrior(aHuff[iHuff], *szName ? szName : NULL, *szAlias ? szAlias : NULL);
...
OS2UINT APIENTRY RUserFileFindClose(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                    PRXSTRING prxsRet)
{
    int iHuff;
...
OS2UINT APIENTRY RUserFileUpdate(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                 PRXSTRING prxsRet)
{
    char szName[PATHLEN];
    char szAlias[PATHLEN];
    ...
    rc = UserFileUpdate(aHuf[iHuf], *szName ? szName : NULL, *szAlias ? szAlias : NULL, &usr);
...
OS2UINT APIENTRY RUserFileClose(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                PRXSTRING prxsRet)
{
    int iHuf;
...
OS2UINT APIENTRY RUserFileInitRecord(PUCHAR pszName, OS2UINT argc, PRXSTRING prxsArgv, PSZ pszQueue,
                                     PRXSTRING prxsRet)
{
    struct _usr usr;
