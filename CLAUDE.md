...
- `mex/mex_tab.c` - Generated by GNU Bison 3.8.2
- `mex/mex_tab.h` - Generated by GNU Bison 3.8.2

These are generated from `mex/mex_tab.y` and are checked into the repository to allow building without requiring Bison. If you modify `mex_tab.y`, regenerate with:
...
**Note**: The generated files are included in version control to simplify the build process, as Bison may not be available on all systems. Changes to the grammar file require Bison 3.8.2 or later for regeneration.
