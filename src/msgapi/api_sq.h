...
dword MAPIENTRY SquishReadMsg(HMSG msgh, PXMSG msg, dword offset, dword bytes, byte OS2FAR *szText,
                              dword clen, byte OS2FAR *ctxt);
sword MAPIENTRY SquishWriteMsg(HMSG msgh, word append, PXMSG msg, byte OS2FAR *text, dword textlen,
