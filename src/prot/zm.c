...
#define GenericIOCtl(hf, class, func, var)                                                         \
    (ulPLen = 0, ulRecvLen = sizeof(var),                                                          \
     DosDevIOCtl(hf, class, func, NULL, 0L, &ulPLen, &var, sizeof(var), &ulRecvLen))
#else
#define GenericIOCtl(hf, class, func, var) DosDevIOCtl(&var, 0L, func, class, hf)
#endif
...
#define FTOFFSET 3
    ...
    "ZCAN",         "ZFREECNT", "ZCOMMAND", "ZSTDERR", "*Error*"
...
static void near zsbh32(char *hdr, int type)
{
    int n;
    long crc;
...
static void near zputhex(int c)
{
...
static void near zsda32(char *buf, int length, int frameend)
{
    int c;
    long crc;
...
static int near zrbhdr32(char *hdr)
{
    int c, n;
    long crc;
...
void canit(void)
{
    static char canistr[] = {24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8};
