...
#define FACT_HIDE                                                                                  \
    0x00000004 /* Do not pass this message to other      *                                         \
                * features.                              */
#define FACT_RWMSG                                                                                 \
    0x00000008 /* Rewrite message.  The header was       *                                         \
...
#define FTACT_AREA                                                                                 \
    0x00000002 /* Toss to the new area tag specified in  *                                         \
                * szArea.                                */
#define FTACT_HIDE                                                                                 \
    0x00000004 /* Do not pass this to any of the other   *                                         \
                * features.                              */
#define FTACT_NSCN                                                                                 \
    0x00000008 /* Do not scan this message to anyone     *                                         \
...
#define FFLAG_NETSENT                                                                              \
    0x00000001 /* Only call FeatureNetMsg for messages  *                                          \
                * which do NOT have the MSGSENT bit     *                                          \
                * set.                                  */

#define FFLAG_NETTOUS                                                                              \
    0x00000002 /* Only call FeatureNetMsg for messages  *                                          \
                * which are to one of our addresses.    */

#define FFLAG_NETRECD                                                                              \
    0x00000004 /* Only call FeatureNetMsg for messages  *                                          \
                * which do not have MSGREAD set.        */

#define FFLAG_NETNOTTOUS                                                                           \
    0x00000008 /* Only call FeatureNetMsg for messages  *                                          \
