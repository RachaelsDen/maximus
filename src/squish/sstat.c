...
{
    return (n1->zone == n2->zone && n1->net == n2->net && n1->node == n2->node &&
            n1->point == n2->point);
}
...
static int near Percent1(dword a, dword b) { return (int)(a * 100L / b); }

static int near Percent2(dword a, dword b) { return (int)((a * 10000L / b) % 100L); }
