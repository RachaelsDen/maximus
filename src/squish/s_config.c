...
static void near V_FwdFrom(char *line, char *ag[]) { Fwd(line, ag, TRUE); }

static void near V_FwdTo(char *line, char *ag[]) { Fwd(line, ag, FALSE); }
...
static void near Parse1Config(char *cfgname, char *args[MAXARGS], char *in, char *line)
{
    FILE *cfgfile;
    char *p, *t;
    char **pparg;
