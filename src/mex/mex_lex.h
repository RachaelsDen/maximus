...
#ifdef MEX_INIT
    = {{"{", T_BEGIN},     {"}", T_END},       {"..", T_RANGE},   {":", T_COLON},
       {">=", T_GE},       {">", T_GT},        {"<=", T_LE},      {"<", T_LT},
       {"=", T_EQUAL},     {"<>", T_NOTEQUAL}, {"+", T_BPLUS},    {"-", T_MINUS},
       {"*", T_BMULTIPLY}, {"/", T_BDIVIDE},   {"%", T_BMODULUS}, {"(", T_LPAREN},
       {")", T_RPAREN},    {"[", T_LBRACKET},  {"]", T_RBRACKET}, {",", T_COMMA},
       {";", T_SEMICOLON}, {"&", T_BAND},      {"|", T_BOR},      {NULL, 0}}
#endif
;
