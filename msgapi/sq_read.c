...
static unsigned near _SquishReadCtrl(HMSG hmsg, byte OS2FAR *szCtrl, dword dwCtrlLen, dword *pdwOfs)
{
...
dword MAPIENTRY SquishReadMsg(HMSG hmsg, PXMSG pxm, dword dwOfs, dword dwTxtLen, byte OS2FAR *szTxt,
