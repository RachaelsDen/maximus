...
#define MSGAPI_ID 0x0201414dL
    ...
    struct _apifuncs
    {
        ...
        dword(MAPIENTRY *ReadMsg)(HMSG msgh, PXMSG msg, dword ofs, dword bytes, byte OS2FAR *text,
                                  dword cbyt, byte OS2FAR *ctxt);
        sword(MAPIENTRY *WriteMsg)(HMSG msgh, word append, PXMSG msg, byte OS2FAR *text,
                                   dword textlen, dword totlen, dword clen, byte OS2FAR *ctxt);
