...
/*      s[0]=(*p   & 0xf0);
    ...
    if (block->dat.voice_data.packing == unpacked)
    {
        ...
        SblastVocPlay((char far *)data, block->block_length, 0x220,
                      (int)((long)blastdelay * 11000L / (long)block->dat.voice_data.sample_rate *
                            11000L / (long)block->dat.voice_data.sample_rate),
