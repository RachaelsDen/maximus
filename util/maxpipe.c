...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        rc1 =
            DosExecPgm(szFailName, 120, EXEC_ASYNCRESULT, szCmdLine, NULL, &rescResults, szCmdLine);
...
int DupHandles(void)
{
    ...
    if (DosMakePipe(&hfStdoutR, &hfStdoutW, 150) || DosMakePipe(&hfStdinR, &hfStdinW, 150) ||
        DosDupHandle(hfStdinR, &sin) || DosDupHandle(hfStdoutW, &serr) ||
