...
int Header_Message(int entry, int silent)
{
    NW(entry);
    NW(silent);
    return 0;
}
int Header_File(int entry, int silent)
{
    NW(entry);
    NW(silent);
    return 0;
}
int Header_Change(int entry, int silent)
{
    NW(entry);
    NW(silent);
    return 0;
...
int File_Get_Download_Names(int do_tag, int protocol)
{
    NW(do_tag);
    NW(protocol);
    return 0;
