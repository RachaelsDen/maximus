        ...
        if (*line)
        {
            ...
            else if (eqstri(p, "address"))
            {
                ...
                else
                {
                    ...
                    Parse_NetNode(p, &prm.address[alias_count].zone, &prm.address[alias_count].net,
                                  &prm.address[alias_count].node, &prm.address[alias_count].point);
            ...
            else if (eqstri(p, "log"))
            {
                ...
                if (eqstri(p, "echomail"))
                {
                    ...
                    if (!*p)
                    {
                        printf("\n\aError!  No EchoToss filename specified on line %d of control "
                               "file!\n",
                               linenum);
                        exit(1);
                    }
